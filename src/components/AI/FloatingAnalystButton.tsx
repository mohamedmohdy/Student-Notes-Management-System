      ...
      <div className="fixed bottom-6 left-6 z-40">
        ...
        >
          ...
          <div className="text-right">
            ...
            <p className="text-[10px] text-indigo-100 font-bold mt-0.5">AI Analyst</p>
          </div>
        </button>
      </div>
