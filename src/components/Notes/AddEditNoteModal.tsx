    ...
    >
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-xs font-bold text-slate-700 mb-2">درجة الأولوية *</label>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm leading-relaxed text-slate-800 focus:ring-2 focus:ring-indigo-500 focus:bg-white transition resize-none"
          ></textarea>
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-800 focus:ring-2 focus:ring-indigo-500 focus:bg-white transition resize-none"
          ></textarea>
        </div>
        ...
        <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200/70 space-y-3">
          <div className="flex items-center justify-between">
            <div>
              <span className="text-sm font-bold text-slate-800">هل تحتاج هذه الملاحظة إلى متابعة؟</span>
              <p className="text-xs text-slate-500">سيتم إدراجها تلقائياً في قائمة مهام المتابعة المستمرة</p>
            </div>
            ...
            <div className="pt-3 border-t border-slate-200 animate-in fade-in duration-200">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3.5 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-800 focus:ring-2 focus:ring-indigo-500"
                />
              </div>
            </div>
          )}
        ...
        <div className="flex items-center justify-end gap-3 pt-3 border-t border-slate-100">
          <button
            ...
            onClick={onClose}
            disabled={loading}
            className="px-5 py-2.5 rounded-xl text-slate-600 hover:bg-slate-100 text-sm font-bold transition"
          >
            إلغاء
          </button>
          <button
            type="submit"
            disabled={loading}
            className="px-6 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold shadow-md shadow-indigo-200 transition active:scale-95 disabled:opacity-50"
          >
